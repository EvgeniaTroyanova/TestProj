...
public class AddProductPage {
    ...
    private By saveButton=By.cssSelector("button.btn.btn-primary.js-btn-save");//By.xpath("//button [contains(@class, \"btn\")and contains(@class, \"btn-primary\") and contains(@class, \"js-btn-save\")] ");
    ...
    public void messageShow(){
        ...
        Assert.assertTrue(driver.findElement(message).getText().contains("Настройки обновлены"),"Message is not shown");
